                ...
                >
                  ...
                  >
                    ...
                    <a
                      ...
                      className={`group/lm mt-2 w-full pt-[14px] pb-[14px] px-4 text-[10px] font-mono font-semibold uppercase tracking-[0.2em] flex items-center justify-center cursor-pointer transition-[text-shadow] duration-300 group-hover/lm:[text-shadow:0_0_8px_rgba(0,0,0,0.9),0_0_2px_rgba(0,0,0,0.9)] ${textColorClass}`}
                      style={{
                    ...
                    >
                      <span className="inline-flex items-center gap-2 transition-transform duration-300 will-change-transform [backface-visibility:hidden] [transform:translateZ(0)] group-hover/lm:scale-[1.0375]">
