                ...
                >
                  ...
                  >
                    ...
                    <a
                      ...
                      className={`mt-2 w-full pt-[14px] pb-[14px] px-4 text-[10px] font-mono font-semibold uppercase tracking-[0.2em] flex items-center justify-center gap-2 cursor-pointer transition-[text-shadow] duration-300 hover:[text-shadow:0_0_8px_rgba(0,0,0,0.9),0_0_2px_rgba(0,0,0,0.9)] ${textColorClass}`}
                      style={{
