      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex" style={{ paddingLeft: MOBILE_CONTENT_ZONE.left, paddingRight: MOBILE_CONTENT_ZONE.right }}>
          <a
            ...
            className="w-full pt-[18px] pb-[18px] px-4 text-[#f3ede2] text-[11px] font-mono font-extrabold uppercase tracking-[0.2em] flex items-center justify-center gap-2 cursor-pointer transition-[text-shadow] duration-300 hover:[text-shadow:0_0_10px_currentColor,0_0_20px_currentColor]"
            style={{
