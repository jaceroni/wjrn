...
export default function StationLanding({ stationId }: StationLandingProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hidden md:flex items-center shrink-0">
          <span className="inline-flex items-center gap-1.5 text-[10px] md:text-[11px] font-mono uppercase tracking-[0.2em] text-white/80">
            Broadcasting
            <Antenna className="w-3 h-3 text-red-500 animate-pulse shrink-0 mr-[2px]" />
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mt-15">
